<template>
  <div :class="partSix">
    ...
    <p class="font-small"><span class="font-bold">前端：</span>HTML/HTML5、CSS/CSS3、JS/ES6、Vue……</p>
    <p class="font-small"><span class="font-bold">其他：</span>MongoDB、MySQL、express</p>
  </div>
</template>
